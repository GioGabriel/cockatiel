...
class _TrainingSessionPageState extends State<TrainingSessionPage>
  ...
  void initState() {
    ...
    if (prefs != null) {
      ...
      if (range.contains('bass')) {
        minFreq = 70;
        maxFreq = 330;
      } else if (range.contains('baritone')) {
        minFreq = 90;
        maxFreq = 400;
      } else if (range.contains('tenor')) {
        minFreq = 130;
        maxFreq = 520;
      } else if (range.contains('alto')) {
        minFreq = 170;
        maxFreq = 700;
      } else if (range.contains('mezzo')) {
        minFreq = 200;
        maxFreq = 900;
      } else if (range.contains('soprano')) {
        minFreq = 250;
        maxFreq = 1100;
      }
    }
              ...
              children: [
                ...
                Text(
                  _isAttemptRunning
                      ...
                      : (_attempts.isNotEmpty
                          ? 'You have completed ${_attempts.length} ${_attemptNoun.toLowerCase()}(s). You can finish now to save your progress and get coaching feedback, or leave.'
                ...
                if (_isAttemptRunning) ...[
                  ElevatedButton.icon(
                    onPressed: () {
                      ...
                      setState(() {
                        _status =
                            '$_attemptNoun ${_attempts.length + 1} resumed.';
                      });
                    },
                ...
                TextButton(
                  ...
                  style: TextButton.styleFrom(
                    foregroundColor: theme.appTokens.danger,
                    padding: const EdgeInsets.symmetric(vertical: 14),
                  ),
                  child: const Text(
                    'Quit Without Saving',
  ...
  Future<void> _finalizeSession() async {
    ...
    try {
      ...
      setState(() {
        _isAwaitingAI = true;
        _status =
            'Feedback review queued. You can continue with other exercises.';
      });
    } catch (error) {
      setState(() {
        _error = _friendlyError(error);
  ...
  List<String> get _queueTips {
    ...
    final focusTips = exerciseSpec.focusMetrics.take(3).map((metric) {
      return 'Focus on ${_metricLabel(metric)} when your review arrives.';
    }).toList();
                    ...
                    children: [
                          ...
                          children: [
                            Expanded(
                              child: _HeroFocusTile(
                                ...
                                supporting:
                                    'Follow the timer and stay relaxed.',
                              ),
                            ),
                            if (_nextRuntimeStage != null) ...[
                              const SizedBox(width: 12),
                          ...
                          child: _runtimePlan != null
                              ? KaraokePitchVisualizer(
                                  ...
                                  currentElapsedSec: _isAttemptRunning
                                      ? _attemptStopwatch.elapsedMilliseconds /
                                          1000.0
                                      : 0.0,
                      ...
                      if (widget.mode != 'karaoke' && _runtimePlan != null) ...[
                        ...
                        _StageStepper(
                          ...
                          elapsedSec: _isAttemptRunning &&
                                  _attemptStopwatch.isRunning
                              ? _attemptStopwatch.elapsedMilliseconds / 1000.0
                              : _attemptElapsedSec.toDouble(),
                        ),
                      ],
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (latestAttempt.passedThreshold !=
                                      null) ...[
                                    const SizedBox(height: 8),
                                    Text(
                    ...
                    Card(
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Feedback review in progress',
                                style: theme.textTheme.titleLarge),
                            const SizedBox(height: 8),
                            Row(
                            ...
                            Wrap(
                              ...
                              children: [
                                FilledButton.tonal(
                                  ...
                                  child: const Text('Open Feedback Processing'),
                                ),
                                OutlinedButton(
...
class _AttemptCountdownRingState extends State<_AttemptCountdownRing>
  ...
  Widget build(BuildContext context) {
    ...
    final pulseStrength = widget.isRunning ? _pulseAnimation.value : 0.0;
