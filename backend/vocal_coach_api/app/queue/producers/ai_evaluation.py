...
def enqueue_ai_evaluation(session_id: str, user_id: str, access_tier: str = "registered", job_id: str | None = None) -> dict[str, Any]:
  priority = 1 if access_tier == "premium" else 2
  job = enqueue(session_id=session_id, user_id=user_id, priority=priority, job_id=job_id)
